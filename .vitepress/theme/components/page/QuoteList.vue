  ...
  <transition name="fade" mode="out-in">
    <div v-if="quote.quote">
      ...
      <blockquote v-if="quote.quote">
        ...
        <cite
          >{{ quote.author }},
          <template v-if="quote.creation && quote.ref_url">
            <a :href="quote.ref_url">{{ quote.creation }}</a>
          </template>
          <template v-else-if="quote.ref_url">
            <a :href="quote.ref_url">{{ quote.ref_url }}</a>
          </template>
          <template v-else-if="quote.creation">
            {{ quote.creation }}
          </template>
